...
const expenseTwo = store.dispatch(addExpense({ description: 'Coffee', amount: '3000', createdAt: -21000 }));
...
const demoState = {
    expenses: [{
        id: 'asdfasdf',
        descriptiong: 'January Rent',
        notes: 'This was the final payment for this address',
        amount: 54500,
        createdAt: 0
    }],
    filters: {
